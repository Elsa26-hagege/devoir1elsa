...
public class frmPrincipal extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(34, 34, 34)
                                .addComponent(sldNbAnnees, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrimeMouseClicked
     ...
     if( sldNbAnnees.getValue() > 5)
       {
           lblPrime.setText("vous payez pas la surprime!!!");
       }
       else
       {
           if (cboSexe.getSelectedItem().toString().compareTo("Homme")==0)
           {
              ...
              if (age>22)
               {
                 lblPrime.setText("vous payez la surprime!!!");  
               }
           }
           else {
                   age = Integer.parseInt(txtAge.getText());
    ...
    private void btnRemboursementMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRemboursementMouseClicked
       ...
       {
           JOptionPane.showMessageDialog(this, "Veuillez saisir votre prix svp!");
       }
       if(btnRemboursement.getText().compareTo("")==0)
       {
           JOptionPane.showMessageDialog(this, "êtes vous membre");
       }
    ...
    private void btnBinaireMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBinaireMouseClicked
       ...
       {
           JOptionPane.showMessageDialog(this, "Veuillez saisir votre entier svp!");
       }
